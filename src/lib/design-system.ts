...
export const fonts = {
  heading: "'Syne', var(--font-syne), sans-serif",
  body: "'DM Sans', var(--font-dm-sans), sans-serif",
...
export const shadows = {
  ...
  glow: '0 4px 16px rgba(124,111,205,0.3)',
  glowLg: '0 8px 32px rgba(124,111,205,0.4)',
} as const;
...
export const interaction = {
  focus: {
    ring: `0 0 0 2px ${colors.bgBase}, 0 0 0 4px ${colors.accent}`,
    ringOffset: '2px',
  },
  hover: {
    scale: 1.02,
